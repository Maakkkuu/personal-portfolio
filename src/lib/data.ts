...
import kenko1 from '$lib/assets/img/kenko_website_1.png';
import kenko2 from '$lib/assets/img/kenko_website_2.png';
...
export const personalInfo = {
	...
	description:
		'A passionate developer with a curious mind and a love for learning new technologies. I am driven to create business-centric solutions and innovations, constantly seeking to enhance my skills and contribute to impactful projects.',
...
export const projects = [
	{
		title: 'Kenko Fitness Gym Website',
		role: 'Backend Developer',
		description:
			'Built with Next.js, Tailwind CSS, and Supabase, this full-stack gym management system streamlines operations through role-based access, membership tracking, and financial analytics dashboards in a centralized platform.',
		link: 'https://kenko-mintal.vercel.app/',
		images: [kenko1, kenko2],
	...
	},
	{
		...
		role: 'Project Lead',
		description:
			'The official website of AWS Cloud Clubs - UP Mindanao. Built with vanilla HTML, CSS, and JavaScript, it serves as the central hub for the organization, featuring workshops and blogs hosted on a separate subdomain.',
	...
	},
	{
		...
		description:
			'A web app streamlining classroom reservations with real-time tracking, forms, and admin controls.',
		link: null,
	...
	},
	{
		...
		description:
			'DurianPy is a volunteer-driven Python community in Davao City promoting Python growth through meetups, workshops, and events.',
	...
	},
	{
		...
		description:
			'A static website showcasing Mintal, Davao City’s café scene, with integrated social media links for easy exploration.',
		link: null,
		images: [cafe1, cafe2],
...
export const organizations = [
	{
		...
		roles: [
			{ title: 'President', date: 'July 2025 - July 2026' },
	...
	},
	{
		...
		roles: [{ title: 'Head of Machine Learning', date: 'January 2025 - February 2026' }],
		logo: awsccLogo
	},
	{
		name: 'AWS User Group Davao',
		roles: [{ title: 'Co-Operations Volunteer', date: 'December 2024 - October 2025' }],
		logo: awsugLogo
	}
];
